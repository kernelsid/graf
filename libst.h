...
int st_keymatch( /* char *str, char *keyword, int minchars */ );

/* Error handling definitions. */
extern char *st_progname;	/* every main() must assign argv[0] to this */
void st_message( /* char *fmt, arg, arg, arg, arg, arg */ );
void st_error( /* char *fmt, arg, arg, arg, arg, arg */ ); /* doesn't return */
void st_perror( /* char *reason */ );			/* doesn't return */
void st_usage( /* char *usage */ );			/* doesn't return */
...
*/
#define st_ulaw_to_linear(ulawbyte) ulaw_table[(unsigned char)ulawbyte]
